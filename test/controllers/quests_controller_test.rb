...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { details: @quest.details, difficulty: @quest.difficulty, items_required: @quest.items_required, quest: @quest.quest }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { details: @quest.details, difficulty: @quest.difficulty, items_required: @quest.items_required, quest: @quest.quest }
    assert_redirected_to quest_path(assigns(:quest))
  end
